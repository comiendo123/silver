...
public class filtroanio extends AppCompatActivity {
    ...
    private List<modelproceso> filtroanio = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filtroanio);
        ...
        vermes=findViewById(R.id.filtroanio);
        ...
        //   ingresar = this.findViewById(R.id.agregarfiltroanio);


           /* ingresar.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), agregarfiltroanio.class);
                    startActivityForResult(intent, 0);
                }
            });
*/
/*
        ...
        Call<ArrayList<modelproceso>> call = apiInterface.getProceso();
        call.enqueue(new Callback<List<modelproceso>>() {
            ...
            public void onResponse(Call<List<modelproceso>> call, retrofit2.Response<List<modelproceso>> response) {
                filtroanio = response.body();
                RecyclerView recyclerView = findViewById(R.id.recyclerdia);
                adaptadorproceso adapter = new adaptadorproceso(filtroanio.this, filtroanio);
                recyclerView.setAdapter(adapter);
                recyclerView.setLayoutManager(new LinearLayoutManager(filtroanio.this));
            }
