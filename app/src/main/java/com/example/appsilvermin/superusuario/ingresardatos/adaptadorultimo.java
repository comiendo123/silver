...
public class adaptadorultimo  extends RecyclerView.Adapter<adaptadorultimo.MyViewHolder> {

    private List<modelproceso> mproceso = new ArrayList<>();
    private Context mContext;
    private static final String Tag = "adaptadorultimo";
    String idds;
    ...
    public adaptadorultimo(Context context, List<modelproceso> proceso) {
    ...
    @NonNull
    @Override
    public adaptadorultimo.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.itemdia, parent, false);
        adaptadorultimo.MyViewHolder holder = new adaptadorultimo.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(adaptadorultimo.MyViewHolder holder, int position) {
