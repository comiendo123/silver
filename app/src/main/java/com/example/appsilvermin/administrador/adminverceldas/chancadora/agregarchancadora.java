...
public class agregarchancadora extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregarchancadora);

      //  id = this.findViewById(R.id.modmarca);
        nombre = this.findViewById(R.id.nombrechancadora);
        descripcion = this.findViewById(R.id.descipcionchancadora);
        seccion = this.findViewById(R.id.seccionchancadora);
        /*celular = this.findViewById(R.id.celulardetallechancadora);
        passwordd = this.findViewById(R.id.ingresarcontrasena);
*/


        ingresar=findViewById(R.id.botoningresarchancadora);
    ...
    private void insertar(){
        ...
        /*    else if(horas1.isEmpty()){
            ...
            progressDialog.show();
            StringRequest request=new StringRequest(Request.Method.POST, "http://10.0.2.2:8000/api/insertarchancado", new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    if (response.equalsIgnoreCase("Datos insertados")) {
                        ...
                        Toast.makeText(agregarchancadora.this, response, Toast.LENGTH_SHORT).show();
                        progressDialog.dismiss();
                    }
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(agregarchancadora.this, error.getMessage(),Toast.LENGTH_SHORT).show();;
                    progressDialog.dismiss();;
                }
            }){
                @Override
            ...
            RequestQueue requestQueue= Volley.newRequestQueue( agregarchancadora.this);
...
/*        initiu();
    ...
    private void initiu() {
        ...
        ingresar = this.findViewById(R.id.botoningresarchancadora);
...
/*    StorageDir /*directory*/
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.botoningresarchancadora) {
            checkPermission();
        ...
        passwordd=this.findViewById(R.id.ingresarcontrasena);
        imagentrabajador=this.findViewById(R.id.imagentr);
        ingresar1=this.findViewById(R.id.botoningresarchancadora);
        cancelar=this.findViewById(R.id.botoncancelaringreso);
        tomarfoto=this.findViewById(R.id.tomarfoto);
...
//INGRESA DATOS BASICOS
    ...
    private void insertar() {
        ...
        if(ci1.isEmpty()){ ci.setError("complete los campos"); }
            ...
            progressDialog.show();
            StringRequest request = new StringRequest(Request.Method.POST, "http://localhost:2000/chancadora",
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
