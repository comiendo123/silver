...
public class agregarmolino extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregarmolino);
        ...
        seccion = this.findViewById(R.id.cantidadreactivos);
        /*celular = this.findViewById(R.id.celulardetallemolino);
...
*/
    ...
    private void insertar(){
        ...
        /*    else if(horas1.isEmpty()){
            ...
            progressDialog.show();
            StringRequest request=new StringRequest(Request.Method.POST, "http://10.0.2.2:8000/api/insertarmolienda", new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    if (response.equalsIgnoreCase("Datos insertados")) {
                        ...
                        Toast.makeText(agregarmolino.this, response, Toast.LENGTH_SHORT).show();
                        progressDialog.dismiss();
                    }
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(agregarmolino.this, error.getMessage(),Toast.LENGTH_SHORT).show();;
                    progressDialog.dismiss();;
                }
            }){
                @Override
            ...
            RequestQueue requestQueue= Volley.newRequestQueue( agregarmolino.this);
...
/*        initiu();
    ...
    private void initiu() {
        ...
        ingresar = this.findViewById(R.id.botoningresarmolino);
...
/*    StorageDir /*directory*/
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.botoningresarmolino) {
            checkPermission();
        ...
        passwordd=this.findViewById(R.id.ingresarcontrasena);
        imagentrabajador=this.findViewById(R.id.imagentr);
        ingresar1=this.findViewById(R.id.botoningresarmolino);
        cancelar=this.findViewById(R.id.botoncancelaringreso);
        tomarfoto=this.findViewById(R.id.tomarfoto);
...
//INGRESA DATOS BASICOS
    ...
    private void insertar() {
        ...
        if(ci1.isEmpty()){ ci.setError("complete los campos"); }
            ...
            progressDialog.show();
            StringRequest request = new StringRequest(Request.Method.POST, "http://localhost:2000/molino",
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
