...
public class adaptadortrabajador extends RecyclerView.Adapter<adaptadortrabajador.MyViewHolder> {

    private List<itemtrabajador> musuario = new ArrayList<>();
    private Context mContext;
    private List<itemtrabajador> mImages = new ArrayList<>();
    private static final String Tag = "adaptadortrabajador";
    String idds;
    ...
    public adaptadortrabajador(Context context, List<itemtrabajador> usuario) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.itemusuarios, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder,  int position) {
        ...
        holder.nombres.setText(musuario.get(holder.getAdapterPosition()).getNombres());
        holder.aellidos.setText(musuario.get(holder.getAdapterPosition()).getApellidos());
    ...
    */
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
     ...
     //       parentlayout = itemView.findViewById(R.id.chancadolayout);
            ...
            aellidos = itemView.findViewById(R.id.horaverchancado);

            imagen = itemView.findViewById(R.id.imagenusuario);

            modificarusuario = itemView.findViewById(R.id.modificarusuario);
            eliminarusuario = itemView.findViewById(R.id.eliminarusuario);
